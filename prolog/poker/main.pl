...
show_rules :- 
    ...
    writeln("As apostas no Limit são Valuees estruturados e pré-determinados.\n"),
    writeln("No pré-flop e no flop, todas as apostas e raises são do mesmo Value do big blind.\n"),
    ...
    writeln("O Value do Small Blind é 2 e do Big Blind é 4.\n"),
